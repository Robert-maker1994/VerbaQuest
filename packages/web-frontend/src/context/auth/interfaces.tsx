...
export interface AuthProvider {
  login: (data: LoginData) => Promise<{ success: boolean; message: string; user?: QuestUser }>;
  register: (data: LoginData) => Promise<{ success: boolean; message?: string; user?: QuestUser }>;
