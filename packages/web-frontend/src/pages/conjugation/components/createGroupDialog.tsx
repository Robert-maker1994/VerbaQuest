import { Chip, Dialog, DialogTitle, TextField, DialogContent, DialogActions, Button } from "@mui/material";
    ...
    return (
        <Dialog maxWidth="lg" open={open} onClose={onClose}>
            ...
            <DialogContent sx={{
                ...
                <DataGrid
                    rows={selectedVerbs.map((verb) => ({ word: verb?.word?.word_text, type: verb.irregular, id: verb.verb_id, myVerbs: false }))}
                    columns={columns}
