    ...
    <HoverBox sx={{ mt: 2 }}>
        ...
        <Grid2 container spacing={2} alignItems="center">
          ...
          <Grid2 size={6}>
            ...
            <Typography variant="body1">{currentRound?.tense.tense} ({currentRound?.tense.mood})</Typography>
          </Grid2>
        </Grid2>
        ...
        {isCorrect !== null && (
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: 2 }}>
            ...
            <Icon color={isCorrect ? 'success' : 'error'}>
              {isCorrect ? <CheckCircleOutline /> : <CancelOutlined />}
            </Icon>
          </Box>
        )}
    </HoverBox>
