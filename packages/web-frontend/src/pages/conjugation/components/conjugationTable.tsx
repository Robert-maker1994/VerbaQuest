    ...
    return (
        <Box>
            ...
            {tenses.map((tense) => (
                    ...
                    <TableContainer key={tense.tense + tense.mood} component={HoverBox} sx={{
                        marginTop: 2
                    }}>
                        <Table>
                            <TableHead>
                                <TableRow>
                                    ...
                                    }}>Conjugation</TableCell>
                                    <TableCell sx={{
                                        [`&.${tableCellClasses.head}`]: {
                                            backgroundColor: "primary.main",
                                            color: "primary.contrastText",
                                        }
                                    }}>Translation</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                {forms.map((form) => (
                                    <TableRow key={form} hover>
                                        ...
                                        <TableCell>
                                            {getConjugation(tense.tense.toLowerCase(), tense.mood.toLowerCase(), form)}
                                        </TableCell>
                                        <TableCell>
                                            {
                                              conjugations.find(c => c.tense.tense === tense.tense.toLowerCase() && c.tense.mood === tense.mood && c.form.form === form)?.translations.map((translation) => (translation.translation))
                                            }
                                        </TableCell>
                                    </TableRow>
                                ))}
