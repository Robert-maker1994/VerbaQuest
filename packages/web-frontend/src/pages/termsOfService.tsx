  ...
  return (
    <Container maxWidth="md">
      <Box my={4}>
        ...
        <Typography>
          Welcome to VerbaQuest! These Terms of Service ("Terms") govern your access to and use of our language learning
        ...
        <Typography>
          ...
          software, text, displays, images, video, and audio) are owned by VerbaQuest and are protected by copyright,
        ...
        <Typography>
          The App is provided on an "as is" and "as available" basis, without any warranties of any kind, either express
          or implied.
        </Typography>
        ...
        <Typography>
          In no event will VerbaQuest be liable for any damages arising out of or in connection with your use of the
          App.
        </Typography>
