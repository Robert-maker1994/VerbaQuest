		...
		<Container maxWidth="md">
			<Box my={4}>
				...
				<ul>
					...
					<li>
						To impersonate or attempt to impersonate VerbaQuest or another user.
					</li>
					<li>
				...
				<Typography>
					...
					displays, images, video, and audio) are owned by VerbaQuest and are
				...
				<Typography>
					In no event will VerbaQuest be liable for any damages arising out of
