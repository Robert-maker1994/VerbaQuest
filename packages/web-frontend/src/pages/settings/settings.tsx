...
const SettingsPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    setIsSaved(false);
    try {
      const updatedData = await backendEndpoints.patchUserSettings(user.user_id, formData);
  ...
  const isFormChanged =
    formData.preferred_learning_language !== initialFormData.preferred_learning_language ||
  ...
  return (
    ...
    >
      ...
      <FormControl fullWidth>
        <InputLabel id="learning-language-label">{translate("language")}</InputLabel>
        <Select
          labelId="learning-language-label"
          id="learning-language-select"
          value={formData.preferred_learning_language}
          label={translate("language")}
          onChange={(event) => handleChange(event, "preferred_learning_language")}
        >
