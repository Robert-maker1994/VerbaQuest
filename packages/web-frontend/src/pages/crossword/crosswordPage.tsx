import { CheckCircleOutline, RadioButtonUncheckedOutlined, Star, StarBorder } from "@mui/icons-material";
...
const CrosswordPage = () => {
  ...
  const handleToggleFavorite = useCallback(async (crosswordId: number, isFavorite: boolean) => {
    try {
        ...
        return {
          ...
          crosswords: prevData.crosswords.map((crossword) => {
            if (crossword.crossword_id === crosswordId) {
              ...
              return {
                ...crossword,
                userCrosswords: crossword.userCrosswords.map((userCrossword) => {
                  return {
                    ...userCrossword,
              ...
              >
                ...
                <Box alignItems={"center"}>
                  <Button
                    onClick={() => {
                      const crossword =
                        crosswordData?.crosswords[Math.floor(Math.random() * crosswordData.crosswords.length)];
                      ...
                      <Card>
                        <CardContent>
                          ...
                          >
                            ...
                            <FavoriteIcon
                              isFavorite={crossword.userCrosswords[0]?.is_favorite}
                              onToggleFavorite={() => {
                                handleToggleFavorite(crossword.crossword_id, crossword.userCrosswords[0]?.is_favorite);
                              }}
                            />
                          </Box>
                          ...
                          >
                            <Typography variant="body1">{translate("status:")}</Typography>
