...
const CrosswordRow = ({ row, rowIndex, metadata, cellData, selectedWord, manageCellNavigation, inputRefs, onCellSelect, wordMap }: {
    row: string[];
    rowIndex: number;
    metadata: WordData[];
    cellData: Map<string, CellData>;
    selectedWord: WordData | null;
    manageCellNavigation: (rowIndex: number, colIndex: number, value: React.KeyboardEvent<HTMLInputElement | HTMLTextAreaElement>) => void;
    inputRefs: RefObject<{
