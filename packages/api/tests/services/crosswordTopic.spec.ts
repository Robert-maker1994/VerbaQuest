...
import { Crosswords, CrosswordTopics, Languages, Topics } from "../../libs/entity";
import { ServiceError } from "../../libs/services/crossword";
import { createCrosswordTopicService, CrosswordTopicError, getAllCrosswordTopics, getCrosswordTopicById, getCrosswordTopicByName, LanguageError } from "../../libs/services/crosswordTopic";
...
describe("crosswordService", () => {
    ...
    describe("getCrosswordTopicById", () => {
        it("should get the pass the correct id to the client", async () => {
            ...
            expect(res).toBe(crosswordTopicResponse);
            expect(client.where).toHaveBeenCalledWith("ct.crossword_topic_id = :id", { id: 1 })
    ...
    describe("getCrosswordTopicByName", () => {
        it("should get the pass the correct name", async () => {
            ...
            expect(res).toBe(crosswordTopicResponse);
            expect(client.where).toHaveBeenCalledWith("unaccent(Lower(t.topic_name)) ILike :name", { name: `%football%` })
    ...
    describe("createCrosswordTopicService", () => {
        ...
        it("should error should be an instant of Crossword topic", async () => {
            ...
            try {
                vi.mocked(crosswordTopic.save).mockRejectedValueOnce(new CrosswordTopicError("nnoo", 500));
