...
describe("translationService", () => {
  ...
  it("get Text for LanguageCode.FRENCH", async () => {
    const translations = await translationService.getTranslations(LanguageCode.FRENCH);
    expect(translations).toEqual({
      ...
      logout: "Déconnexion",
      "here_are_the crosswords_you_have_previously_attempted:": "Voici les mots croisés que vous avez déjà essayés :",
      not_attempted_crosswords: "Vous n'avez pas encore essayé de mots croisés.",
      ...
      completed_crossword: "Vous avez résolu les mots croisés ! Excellent travail !",
  ...
  it("get Text for LanguageCode.SPANISH", async () => {
    const translations = await translationService.getTranslations(LanguageCode.SPANISH);
    expect(translations).toEqual({
      dashboard: "Tablero",
  ...
  it("get Text for LanguageCode.ENGLISH", async () => {
    const translations = await translationService.getTranslations(LanguageCode.ENGLISH);
    expect(translations).toEqual({
      dashboard: "Dashboard",
      crossword: "Crossword",
