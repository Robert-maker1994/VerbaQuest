...
export class UserCrossword {
  ...
  @Column({
    type: "int",
    nullable: false,
    comment: "Foreign key to the Users table, representing the user who completed the crossword.",
  })
  user_id: number;
  ...
  @Column({
    type: "int",
    nullable: false,
    comment: "Foreign key to the Crossword table, representing the completed crossword.",
  })
  crossword_id: number;
