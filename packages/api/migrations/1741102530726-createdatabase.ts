...
export class CreateDatabase1741102530726 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "languages" ("language_id" SERIAL NOT NULL, "language_code" "public"."languages_language_code_enum" NOT NULL, "language_name" "public"."languages_language_name_enum" NOT NULL, CONSTRAINT "PK_108420613c85f301619cf49234d" PRIMARY KEY ("language_id"))`);
        await queryRunner.query(`CREATE TABLE "topic" ("topic_id" SERIAL NOT NULL, "topic_name" citext NOT NULL, "language_id" integer, CONSTRAINT "UQ_b07c38f7593a528dd6d5e85e511" UNIQUE ("topic_name"), CONSTRAINT "PK_d91aa173b2e6549130633b15a2d" PRIMARY KEY ("topic_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "crossword_word" ("crossword_word_id" SERIAL NOT NULL, "clue" text NOT NULL, "crossword_id" integer, "word_id" integer, CONSTRAINT "UQ_1c6bac704152540d25a3ec23ab2" UNIQUE ("crossword_id", "word_id"), CONSTRAINT "PK_3a6d4504682127e83fa0cf3ddb8" PRIMARY KEY ("crossword_word_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_crossword" ("user_crossword_id" SERIAL NOT NULL, "grid_state" text, "completed" boolean NOT NULL DEFAULT false, "last_attempted" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" integer, "crossword_id" integer, CONSTRAINT "PK_061ab7644dbb204e1fdcba11440" PRIMARY KEY ("user_crossword_id"))`);
        await queryRunner.query(`CREATE INDEX "idx_user_crossword_progress_user_id" ON "user_crossword" ("user_id") `);
        await queryRunner.query(`CREATE INDEX "idx_user_crossword_progress_crossword_id" ON "user_crossword" ("crossword_id") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_user_crossword_progress_crossword_id"`);
        await queryRunner.query(`DROP INDEX "public"."idx_user_crossword_progress_user_id"`);
