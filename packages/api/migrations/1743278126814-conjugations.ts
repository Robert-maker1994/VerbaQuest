  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    try {
      ...
      if (spanish && english) {
        ...
        const pastSimpleIndicativeEnglish = await tenseRepository.findOne({
          where: { tense: "past simple", mood: "indicative", language: english },
        });
        ...
        const formEllosEllasUstedes = await formRepository.findOne({
          where: { form: "ellos/ellas/ustedes", language: spanish },
        });
        ...
        if (
          !presenteIndicativeSpanish &&
          !presenteSubjunctiveSpanish &&
          !preteritoIndefinidoIndicativeSpanish &&
          !presentSimpleIndicativeEnglish &&
          !pastSimpleIndicativeEnglish
        ) {
        ...
        await conjugationRepository.insert([
          ...
          {
            verb: jugarVerb,
            tense: presenteIndicativeSpanish,
            form: formTu,
            conjugation: "juegas",
            is_irregular: false,
          },
          ...
          {
            verb: jugarVerb,
            tense: presenteSubjunctiveSpanish,
            form: formYo,
            conjugation: "juegue",
            is_irregular: true,
          },
          ...
          {
            verb: jugarVerb,
            tense: preteritoIndefinidoIndicativeSpanish,
            form: formYo,
            conjugation: "jugué",
            is_irregular: true,
          },
        ...
        await conjugationRepository.insert([
          {
            verb: await verbRepository.findOneBy({ word: listenWord }),
            tense: presentSimpleIndicativeEnglish,
            form: formI,
            conjugation: "listen",
            is_irregular: false,
          },
          ...
          {
            verb: await verbRepository.findOneBy({ word: listenWord }),
            tense: pastSimpleIndicativeEnglish,
            form: formI,
            conjugation: "listened",
            is_irregular: false,
          },
          {
            verb: await verbRepository.findOneBy({ word: listenWord }),
        ...
        console.info("Conjugations seeded successfully!");
      }
    } catch (error) {
