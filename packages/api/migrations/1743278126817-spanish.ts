...
import { Crossword, CrosswordWord, Languages, Topic, Word } from "../libs/entity";
...
export class Spanish1743278126817 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    if (!targetLanguage) {
      throw new Error(`Target language with code ${targetLanguageCode} not found.`);
    }
    ...
    try {
      await queryRunner.manager.save(Array.from(topicsMap.values()));
