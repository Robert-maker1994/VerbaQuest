...
export class UpdateDatabase1742069418100 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "user_word_progress" ADD CONSTRAINT "FK_9079eff21093d1ad1cad76be838" FOREIGN KEY ("word_id") REFERENCES "words"("word_id") ON DELETE CASCADE ON UPDATE NO ACTION`,
		);
		await queryRunner.query(
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "user_word_progress" DROP CONSTRAINT "FK_9079eff21093d1ad1cad76be838"`,
		);
		await queryRunner.query(
			`ALTER TABLE "user_word_progress" DROP CONSTRAINT "FK_cf40bfcc7eebd1d3e995f1062ec"`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`DROP TYPE "public"."user_preferred_difficulty_enum"`,
		);
		await queryRunner.query(`DROP TYPE "public"."user_app_language_enum"`);
		await queryRunner.query(
			`DROP TYPE "public"."user_preferred_learning_language_enum"`,
		);
		...
		await queryRunner.query(
			`DROP TYPE "public"."languages_language_code_enum"`,
		);
