...
export class UpdateDatabase1742069418100 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_word_progress" ADD CONSTRAINT "FK_9079eff21093d1ad1cad76be838" FOREIGN KEY ("word_id") REFERENCES "words"("word_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
