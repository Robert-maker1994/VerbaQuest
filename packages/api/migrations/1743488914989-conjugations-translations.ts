...
class MigrationError extends Error {
  constructor(
    message: string,
    public readonly details?: DebugDetails,
  ) {
    super(message);
...
export class ConjugationsTranslations1743488914989 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    console.info("Starting Conjugation Translations Migration...");
    const languageRepository = queryRunner.manager.getRepository(Languages);
    await languageRepository.save([{ language_code: LanguageCode.FRENCH, language_name: LanguageName.FRENCH }]);
    ...
    try {
      console.info("Fetching 'jugar' verb...");
      ...
      console.info("Fetching conjugations for 'jugar'...");
      ...
      console.info("Preparing translations...");
      ...
      console.info("Creating and saving translations...");
      ...
      console.info("Conjugation translations for 'jugar' seeded successfully!");
    } catch (error) {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    console.info("Starting down migration...");
    try {
      ...
      console.info("Conjugation translations deleted successfully!");
    } catch (error) {
